...
- project structure
- AGENTS.md
- class names from the request
- API endpoints
- service names
- repository names
- related DTO/entity names

Search first.

Read only files that are necessary to understand the requested flow.
...
SUMMARY:
Short explanation of what was discovered.